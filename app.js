...
let appState = {
  ...
  entries: [],
  loadingLocations: ['Location A', 'Location B', 'Location C', 'Warehouse Alpha', 'Port Terminal 1'],
  unloadingLocations: ['Location X', 'Location Y', 'Location Z', 'Distribution Center 2', 'Factory Depot'],
  globalMargin: 0.0
};
